...
def main():
    proj = angr.Project("break_the_chain", auto_load_libs=False) 
    ...
    state = proj.factory.entry_state(stdin=flag1, add_options={angr.options.LAZY_SOLVES, angr.options.UNICORN})
    ...
    simgr.explore(find=0x4009fb, avoid=[0x400820, 0x400880, 0x4009d8, 0x40099c])
    if simgr.found:
